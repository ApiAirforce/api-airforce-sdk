...
class Airforce:
    ...
    def __init__(
        ...
        *,
        ...
        self.embeddings = r.Embeddings(self._transport)
        ...
        self.three_d = r.ThreeD(self._transport)
        self.voices = r.Voices(self._transport)
        self.account = r.Account(self._transport)
        self.notifications = r.Notifications(self._transport)
        self.org = r.Org(self._transport)
...
class AsyncAirforce:
    ...
    def __init__(
        ...
        *,
        ...
        self.embeddings = r.AsyncEmbeddings(self._transport)
        ...
        self.three_d = r.AsyncThreeD(self._transport)
        self.voices = r.AsyncVoices(self._transport)
        self.account = r.AsyncAccount(self._transport)
        self.notifications = r.AsyncNotifications(self._transport)
        self.org = r.AsyncOrg(self._transport)
